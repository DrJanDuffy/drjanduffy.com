...
export const metadata = {
  title: 'Mountains Edge HOMES THAT DIDN\'T SELL | Dr. Jan Duffy - Las Vegas Real Estate Expert',
  description:
    'Expert help selling homes that didn\'t sell in Mountains Edge, Las Vegas. Family-friendly master-planned community properties. 19 day average, 98.7% of asking price.',
  alternates: {
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-primary/10 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Mountains Edge homes fail to sell for the same reasons other family-oriented community homes fail to sell - poor marketing, minimal investment, and zero follow-up. But Mountains Edge properties face unique challenges that most agents don't understand or address.
                </p>
                <h3 className="text-2xl font-bold mb-3">Family-Oriented Marketing</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Mountains Edge properties require specialized family-oriented marketing. Professional photography showcasing family amenities. Strategic positioning emphasizing family benefits. Marketing targeting family buyers. Most agents don't understand family-oriented marketing. They use generic strategies, don't highlight family features, and fail to target family buyers. I understand family-oriented marketing. I use specialized strategies, highlight family features, and target family buyers who value these properties.
                </p>
                <h3 className="text-2xl font-bold mb-3">School Quality Value</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Mountains Edge offers excellent schools that add significant value. Buyers pay premium prices for quality schools, family amenities, and family-oriented features. Most agents don't understand this value. They don't showcase school quality. They don't explain school benefits. They don't emphasize family-oriented features. I understand this value. I showcase school quality. I explain school benefits. I emphasize family-oriented features. I attract family buyers who understand and value quality schools.
                </p>
                <h3 className="text-2xl font-bold mb-3">Family Amenities Positioning</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Mountains Edge offers family amenities through master-planned design and family-oriented features. Buyers value these amenities and expect them to be highlighted. Most agents don't highlight family amenities. They don't explain master-planned design advantages. They don't showcase family-oriented features. They don't emphasize family amenities. I highlight family amenities. I explain master-planned design advantages. I showcase family-oriented features. I emphasize family amenities. I attract buyers who value family-oriented communities.
                </p>
              </div>
              ...
              <div className="bg-gray-100 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Mountains Edge properties require highlighting family amenities. Buyers need to understand amenity benefits, family-oriented features, and school quality advantages. Most agents don't explain these benefits. They don't showcase family amenities. They don't emphasize family-oriented features. I explain these benefits. I showcase family amenities. I emphasize family-oriented features. I attract family buyers who understand and value family-oriented communities.
                </p>
                <h3 className="text-2xl font-bold mb-3">School Quality Strategy</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Mountains Edge requires school quality strategy. Buyers expect school quality information, family amenity details, and family-oriented presentation. Most agents don't provide this. They use generic information, don't highlight school quality, and fail to showcase family amenities. I provide school quality information, highlight family amenities, and showcase family-oriented features that attract buyers who value family communities.
                </p>
              </div>
