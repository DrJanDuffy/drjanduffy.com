...
export const metadata = {
  title: 'Summerlin Lofts / C2 Lofts Las Vegas | Expired Listing Expert | Dr. Jan Duffy',
  description:
    'Expert help selling expired Summerlin Lofts in Las Vegas. Urban lofts with modern design. 30-day guarantee or work free.',
}
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none mb-12">
                <p className="text-lg text-gray-700 mb-6">
                  Summerlin Lofts, also known as C2 Lofts, is an urban loft building in Summerlin that offers sophisticated living with modern design, community amenities, and prime Summerlin location. If your Summerlin Lofts listing expired, you're not alone. Summerlin Lofts face unique challenges - from marketing urban lifestyle to highlighting modern design to buyers who value community living. Most agents don't understand Summerlin Lofts. They use generic strategies, and Summerlin Lofts expire.
                </p>
                <p className="text-lg text-gray-700 mb-6">
              ...
              <div className="bg-gray-100 p-8 rounded-lg mb-12">
                <h2 className="text-3xl font-black mb-4">Summerlin Lofts Features</h2>
                <p className="text-lg text-gray-700 mb-4">
                  Summerlin Lofts offers urban lofts with modern design, community amenities, and prime Summerlin location. Understanding these features is essential for effective marketing.
                </p>
              ...
              <div className="bg-white border-2 border-primary rounded-lg p-8 mb-12">
                <h2 className="text-3xl font-black mb-4">My Summerlin Lofts Marketing Strategy</h2>
                <p className="text-lg text-gray-700 mb-4">
                  I have a proven strategy for marketing Summerlin Lofts. This strategy addresses unique challenges, highlights unique features, and attracts urban lifestyle seekers. It sells Summerlin Lofts. Fast. At top dollar.
                </p>
              ...
              <div className="bg-primary text-primary-foreground p-8 rounded-lg mb-12 text-center">
                ...
                <p className="text-lg opacity-90">
                  No excuses. No exceptions. If your Summerlin Lofts listing doesn't sell in 30 days, I continue working at no additional cost until it sells. That's how confident I am in my Summerlin Lofts marketing system.
                </p>
              </div>
              ...
              <div className="bg-white border-2 border-gray-200 rounded-lg p-8">
                ...
                <p className="text-center text-lg text-gray-700 mb-6">
                  If your Summerlin Lofts listing expired, don't wait. Every day costs you money. Call me now at (702) 500-1064 or fill out the form below for a free consultation.
                </p>
