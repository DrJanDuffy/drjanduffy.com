...
export const metadata = {
  title: 'Soho Lofts Las Vegas | Expired Listing Expert | Dr. Jan Duffy',
  description:
    'Expert help selling expired Soho Lofts in Las Vegas. Urban lofts with modern design. 30-day guarantee or work free.',
}
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none mb-12">
                <p className="text-lg text-gray-700 mb-6">
                  Soho Lofts is an urban loft building in Las Vegas that offers sophisticated living with modern design, contemporary amenities, and urban location. If your Soho Lofts listing expired, you're not alone. Soho Lofts face unique challenges - from marketing urban lifestyle to highlighting modern design to buyers who value contemporary living. Most agents don't understand Soho Lofts. They use generic strategies, and Soho Lofts expire.
                </p>
                <p className="text-lg text-gray-700 mb-6">
              ...
              <div className="bg-primary/10 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Soho Lofts expire for the same reasons other urban lofts expire - poor marketing, minimal investment, and zero follow-up. But Soho Lofts face additional challenges that most agents don't understand or address.
                </p>
              ...
              <div className="bg-gray-100 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Soho Lofts offer urban lifestyle with urban location, walkability, and urban amenities. Most agents don't market urban lifestyle effectively. I do. I showcase urban location, highlight walkability, and emphasize urban amenities that attract urban-conscious buyers.
                </p>
                <h3 className="text-2xl font-bold mb-3">Modern Design</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Soho Lofts offer modern design with contemporary finishes, sleek interiors, and urban aesthetic. Most agents don't highlight modern design effectively. I do. I showcase contemporary finishes, emphasize sleek interiors, and highlight urban aesthetic that attracts design-conscious buyers.
                </p>
                <h3 className="text-2xl font-bold mb-3">Contemporary Amenities</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Soho Lofts offer contemporary amenities including fitness center, rooftop access, and urban features. Most agents don't showcase amenities effectively. I do. I showcase fitness center, emphasize rooftop access, and highlight urban features that attract amenity-conscious buyers.
                </p>
              </div>
              ...
              <div className="bg-white border-2 border-primary rounded-lg p-8 mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Soho Lofts offer urban lifestyle. I highlight this lifestyle effectively. I showcase urban location, highlight walkability, and emphasize urban amenities that attract urban-conscious buyers. Most agents don't do this. They use generic marketing, and Soho Lofts expire.
                </p>
                <h3 className="text-2xl font-bold mb-3">Urban Lifestyle Seeker Targeting</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Soho Lofts attract urban lifestyle seekers. Young professionals. Urban enthusiasts. Contemporary living seekers. Most agents don't know how to target these buyers. I do. I use targeted advertising, urban-focused marketing, and contemporary positioning that attracts urban-conscious buyers.
                </p>
              </div>
              ...
              <div className="bg-primary text-primary-foreground p-8 rounded-lg mb-12 text-center">
                ...
                <p className="text-lg opacity-90">
                  No excuses. No exceptions. If your Soho Lofts listing doesn't sell in 30 days, I continue working at no additional cost until it sells. That's how confident I am in my Soho Lofts marketing system.
                </p>
              </div>
              ...
              <div className="bg-white border-2 border-gray-200 rounded-lg p-8">
                ...
                <p className="text-center text-lg text-gray-700 mb-6">
                  If your Soho Lofts listing expired, don't wait. Every day costs you money. Call me now at (702) 500-1064 or fill out the form below for a free consultation.
                </p>
