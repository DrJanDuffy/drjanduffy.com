...
export const metadata = {
  ...
  description:
    'Expert help selling expired Terra Bella at Anthem condos in Henderson. Mid-rise condos with community amenities. Proven results and professional marketing.',
}
export default function TerraBellaCondosPage() {
  const faqs = [
    {
      question: 'What real estate services does Dr. Jan Duffy provide for Terra Bella at Anthem condos in Henderson?',
      answer:
        'Dr. Jan Duffy provides complete real estate services for Terra Bella at Anthem condos that did not sell, including professional photography ($3,700 investment), staging, 97-point marketing system, strategic pricing for mid-rise condos, specialized marketing highlighting community amenities and Anthem location, and attracting value-conscious buyers. She specializes in Terra Bella at Anthem in Henderson.',
    },
    {
      question: 'How long does it take to sell a Terra Bella at Anthem condo in Henderson?',
      answer:
        'Dr. Jan Duffy\'s average is 19 days from listing to contract for Terra Bella at Anthem condos that did not sell. She specializes in mid-rise condos with community amenities in Henderson and uses strategic marketing to attract buyers seeking value and community living, achieving fast sales at top dollar.',
    },
    {
      question: 'Why choose Dr. Jan Duffy to sell my Terra Bella at Anthem condo?',
      answer:
        'Dr. Jan Duffy specializes in Terra Bella at Anthem condos and understands Henderson mid-rise condo marketing, the importance of highlighting community amenities, and value positioning. She invests $5,000+ per listing in professional marketing and has proven results selling Terra Bella condos that did not sell with previous agents.',
    },
    {
      question: 'What makes Terra Bella at Anthem condos unique in Henderson?',
      answer:
        'Terra Bella at Anthem is a mid-rise condominium building in Henderson offering community living with amenities and value. Dr. Jan Duffy specializes in marketing these Henderson condos and has proven results selling Terra Bella condos that did not sell with other agents.',
    },
  ]
  ...
  return (
    <>
      <BreadcrumbSchema items={[
        ...
        { name: 'Terra Bella at Anthem Condos', url: '/condos/terra-bella' },
      ]} />
      <FAQSchema faqs={faqs} />
      <Header />
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none mb-12">
                <p className="text-lg text-gray-700 mb-6">
                  Terra Bella at Anthem is a mid-rise condominium community in Henderson that offers affordable living with community amenities, established neighborhoods, and value positioning. If your Terra Bella at Anthem condo home DID NOT sell, you're not alone. Terra Bella condos face unique challenges - from competition with new construction to value-conscious buyers to emphasis on community amenities. Most agents do not understand Terra Bella condos. They use generic strategies, and Terra Bella condos expire.
                </p>
                <p className="text-lg text-gray-700 mb-6">
              ...
              <div className="bg-white border-2 border-gray-200 rounded-lg p-8">
                ...
                <p className="text-center text-lg text-gray-700 mb-6">
                  If your Terra Bella at Anthem condo home DID NOT sell, do not wait. Every day costs you money. Call me now at (702) 500-1064 or fill out the form below for a free consultation.
                </p>
