            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-primary/10 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Martin condos expire for the same reasons other luxury condos expire - poor marketing, minimal investment, and zero follow-up. But Martin condos face additional challenges that most agents don't understand or address.
                </p>
                <h3 className="text-2xl font-bold mb-3">Modern Design Marketing</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Martin condos offer modern design. Buyers need to understand modern appeal. Most agents don't market modern design effectively. They don't explain benefits. They don't showcase contemporary finishes. They don't highlight urban aesthetic. I market modern design effectively. I explain benefits, showcase contemporary finishes, and highlight urban aesthetic that attracts design-conscious buyers.
                </p>
              ...
              <div className="bg-gray-100 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Martin offers modern design with contemporary finishes, sleek interiors, and urban aesthetic. Most agents don't highlight modern design effectively. I do. I showcase contemporary finishes, emphasize sleek interiors, and highlight urban aesthetic that attracts design-conscious buyers.
                </p>
                <h3 className="text-2xl font-bold mb-3">Exclusive Amenities</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Martin offers exclusive amenities including concierge services, private pools, exclusive events, and sophisticated design. Most agents don't highlight exclusive amenities effectively. I do. I showcase concierge services, emphasize private pools, highlight exclusive events, and showcase sophisticated design that attracts amenity-conscious buyers.
                </p>
              ...
              <div className="bg-white border-2 border-primary rounded-lg p-8 mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Martin condos require luxury marketing investment. Professional photography. Luxury staging. Exclusive access events. High-end advertising. Most agents don't invest in luxury marketing. I invest $5,000+ in professional media, luxury staging, and exclusive marketing that attracts luxury lifestyle seekers.
                </p>
                <h3 className="text-2xl font-bold mb-3">Modern Design Highlighting</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Martin condos offer modern design. I highlight this design effectively. I showcase contemporary finishes, emphasize sleek interiors, and highlight urban aesthetic that attracts design-conscious buyers. Most agents don't do this. They use generic marketing, and Martin condos expire.
                </p>
