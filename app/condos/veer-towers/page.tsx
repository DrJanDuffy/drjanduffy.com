...
export const metadata = {
  title: 'Veer Towers Condos Las Vegas | Expired Listing Expert | Dr. Jan Duffy',
  description:
    'Expert help selling expired Veer Towers condos in Las Vegas. Luxury CityCenter condos with modern design. 30-day guarantee or work free.',
}
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-gray-100 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Veer Towers condos offer CityCenter access including restaurants, shopping, entertainment, and amenities. Most agents don't market CityCenter access effectively. I do. I showcase restaurants, highlight shopping, emphasize entertainment, and showcase amenities that attract access-conscious buyers.
                </p>
                <h3 className="text-2xl font-bold mb-3">Modern Design</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Veer Towers offers modern design with contemporary finishes, sleek interiors, and urban aesthetic. Most agents don't highlight modern design effectively. I do. I showcase contemporary finishes, emphasize sleek interiors, and highlight urban aesthetic that attracts design-conscious buyers.
                </p>
                <h3 className="text-2xl font-bold mb-3">World-Class Amenities</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Veer Towers offers world-class amenities including pool, fitness center, concierge, and exclusive access. Most agents don't showcase amenities effectively. I do. I showcase pool, emphasize fitness center, highlight concierge, and showcase exclusive access that attracts amenity-conscious buyers.
                </p>
              </div>
              ...
              <div className="bg-white border-2 border-primary rounded-lg p-8 mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Veer Towers condos require luxury marketing investment. Professional photography. Luxury staging. Exclusive access events. High-end advertising. Most agents don't invest in luxury marketing. I invest $5,000+ in professional media, luxury staging, and exclusive marketing that attracts modern design enthusiasts.
                </p>
                <h3 className="text-2xl font-bold mb-3">CityCenter Access Highlighting</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Veer Towers condos offer CityCenter access. I highlight this access effectively. I showcase restaurants, highlight shopping, emphasize entertainment, and showcase amenities that attract access-conscious buyers. Most agents don't do this. They use generic marketing, and Veer Towers condos expire.
                </p>
                <h3 className="text-2xl font-bold mb-3">Modern Design Enthusiast Targeting</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Veer Towers attracts modern design enthusiasts. Young professionals. Design-conscious buyers. Urban lifestyle seekers. Most agents don't know how to target these buyers. I do. I use targeted advertising, exclusive access events, and modern marketing that attracts design-conscious buyers.
                </p>
              </div>
              ...
              <div className="bg-primary text-primary-foreground p-8 rounded-lg mb-12 text-center">
                ...
                <p className="text-lg opacity-90">
                  No excuses. No exceptions. If your Veer Towers condo doesn't sell in 30 days, I continue working at no additional cost until it sells. That's how confident I am in my Veer Towers condo marketing system.
                </p>
              </div>
              ...
              <div className="bg-white border-2 border-gray-200 rounded-lg p-8">
                ...
                <p className="text-center text-lg text-gray-700 mb-6">
                  If your Veer Towers condo listing expired, don't wait. Every day costs you money. Call me now at (702) 500-1064 or fill out the form below for a free consultation.
                </p>
