...
export const metadata = {
  title: 'Palms Place Condos Las Vegas | Expired Listing Expert | Dr. Jan Duffy',
  description:
    'Expert help selling expired Palms Place condos in Las Vegas. Luxury condo hotel with resort access. 30-day guarantee or work free.',
}
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-primary/10 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Palms Place condos expire for the same reasons other condo hotels expire - poor marketing, minimal investment, and zero follow-up. But Palms Place condos face additional challenges that most agents don't understand or address.
                </p>
              ...
              <div className="bg-gray-100 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Palms Place condos offer Palms resort access including pools, restaurants, entertainment, and amenities. Most agents don't market resort access effectively. I do. I showcase pools, highlight restaurants, emphasize entertainment, and showcase amenities that attract resort-conscious buyers.
                </p>
                <h3 className="text-2xl font-bold mb-3">Rental Programs</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Palms Place offers rental programs with hotel management, income potential, and rental history. Most agents don't explain rental programs effectively. I do. I explain hotel management, highlight income potential, and showcase rental history that attracts investors.
                </p>
              ...
              <div className="bg-white border-2 border-primary rounded-lg p-8 mb-12">
                ...
                <h3 className="text-2xl font-bold mb-3">Rental Program Explanation</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Palms Place condos offer rental programs. I explain these programs effectively. I explain hotel management, highlight income potential, and showcase rental history that attracts investors. Most agents don't do this. They use generic explanations, and Palms Place condos expire.
                </p>
                <h3 className="text-2xl font-bold mb-3">Investor Network</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Palms Place attracts investors. I have a network of investors seeking rental properties. I use this network to market Palms Place condos effectively. Most agents don't have this network. They use generic advertising, and Palms Place condos expire.
                </p>
              </div>
              ...
              <div className="bg-primary text-primary-foreground p-8 rounded-lg mb-12 text-center">
                ...
                <p className="text-lg opacity-90">
                  No excuses. No exceptions. If your Palms Place condo doesn't sell in 30 days, I continue working at no additional cost until it sells. That's how confident I am in my Palms Place condo marketing system.
                </p>
              </div>
              ...
              <div className="bg-white border-2 border-gray-200 rounded-lg p-8">
                ...
                <p className="text-center text-lg text-gray-700 mb-6">
                  If your Palms Place condo listing expired, don't wait. Every day costs you money. Call me now at (702) 500-1064 or fill out the form below for a free consultation.
                </p>
