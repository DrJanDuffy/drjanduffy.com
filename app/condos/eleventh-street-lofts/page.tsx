            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-primary/10 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Eleventh Street Lofts expire for the same reasons other urban lofts expire - poor marketing, minimal investment, and zero follow-up. But Eleventh Street Lofts face additional challenges that most agents don't understand or address.
                </p>
              ...
              <div className="bg-gray-100 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Eleventh Street Lofts offer urban lifestyle with urban location, walkability, and urban amenities. Most agents don't market urban lifestyle effectively. I do. I showcase urban location, highlight walkability, and emphasize urban amenities that attract urban-conscious buyers.
                </p>
                <h3 className="text-2xl font-bold mb-3">Modern Design</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Eleventh Street Lofts offer modern design with contemporary finishes, sleek interiors, and urban aesthetic. Most agents don't highlight modern design effectively. I do. I showcase contemporary finishes, emphasize sleek interiors, and highlight urban aesthetic that attracts design-conscious buyers.
                </p>
              ...
              <div className="bg-white border-2 border-primary rounded-lg p-8 mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Eleventh Street Lofts offer urban lifestyle. I highlight this lifestyle effectively. I showcase urban location, highlight walkability, and emphasize urban amenities that attract urban-conscious buyers. Most agents don't do this. They use generic marketing, and Eleventh Street Lofts expire.
                </p>
