            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-primary/10 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Mid-rise condos expire for the same reasons other condos expire - poor marketing, minimal investment, and zero follow-up. But mid-rise condos face additional challenges that most agents don't understand or address.
                </p>
                <h3 className="text-2xl font-bold mb-3">Modern Design Marketing</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Mid-rise condos offer modern design. Open floor plans. High ceilings. Contemporary finishes. Most agents don't market modern design effectively. They don't highlight open floor plans. They don't showcase high ceilings. They don't emphasize contemporary finishes. I market modern design effectively. I highlight open floor plans, showcase high ceilings, and emphasize contemporary finishes that attract design-conscious buyers.
                </p>
                <h3 className="text-2xl font-bold mb-3">Community Amenity Positioning</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Mid-rise condos offer community amenities. Fitness centers. Pools. Community spaces. Most agents don't position community amenities effectively. They don't highlight fitness centers. They don't showcase pools. They don't emphasize community spaces. I position community amenities effectively. I highlight fitness centers, showcase pools, and emphasize community spaces that attract community-conscious buyers.
                </p>
              ...
              <div className="bg-gray-100 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Mid-rise condos offer modern design. I highlight this design effectively. I showcase open floor plans, emphasize high ceilings, and highlight contemporary finishes that attract design-conscious buyers. Most agents don't do this. They use generic marketing, and mid-rise condos expire.
                </p>
                <h3 className="text-2xl font-bold mb-3">Community Amenity Showcasing</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Mid-rise condos offer community amenities. I showcase these amenities effectively. I highlight fitness centers, emphasize pools, and showcase community spaces that attract community-conscious buyers. Most agents don't do this. They use generic marketing, and mid-rise condos expire.
                </p>
