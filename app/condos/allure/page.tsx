            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="bg-primary/10 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Allure condos expire for the same reasons other luxury condos expire - poor marketing, minimal investment, and zero follow-up. But Allure condos face additional challenges that most agents don't understand or address.
                </p>
                <h3 className="text-2xl font-bold mb-3">Strict Building Restrictions</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Allure has strict building restrictions. Limited open houses. Restricted photography. Complex approval processes. Most agents don't know how to work within these restrictions. They try to market Allure condos like regular condos, hit restrictions, and give up. I know how to market Allure condos effectively within building restrictions. I use digital marketing, exclusive access events, and targeted advertising that doesn't violate building rules.
                </p>
                <h3 className="text-2xl font-bold mb-3">Competition from Newer Buildings</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Allure competes with newer luxury buildings. Newer amenities. Newer designs. Newer marketing. Most agents don't know how to position Allure against newer buildings. They don't highlight Allure's unique features. They don't emphasize established community. I know how to position Allure competitively. I highlight unique features. I emphasize established community. I showcase Allure's timeless appeal.
                </p>
              ...
              <div className="bg-gray-100 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Allure offers luxury amenities including concierge services, fitness centers, resort-style pools, and exclusive access. Most agents don't highlight these amenities effectively. I do. I showcase concierge services, emphasize fitness centers, highlight resort-style pools, and showcase exclusive access that attracts high-end buyers.
                </p>
                <h3 className="text-2xl font-bold mb-3">Prime Location</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Allure's prime location offers proximity to world-class entertainment, dining, and shopping. Most agents don't emphasize location effectively. I do. I highlight proximity to entertainment, showcase dining options, and emphasize shopping access that attracts location-conscious buyers.
                </p>
              ...
              <div className="bg-white border-2 border-primary rounded-lg p-8 mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Allure condos require luxury marketing investment. Professional photography. Luxury staging. Exclusive access events. High-end advertising. Most agents don't invest in this level of marketing. I invest $5,000+ in professional media, luxury staging, and exclusive marketing that attracts high-end buyers.
                </p>
                <h3 className="text-2xl font-bold mb-3">High-End Buyer Targeting</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Allure attracts high-end buyers. Investors. Second-home buyers. Luxury lifestyle seekers. Most agents don't know how to target these buyers. I do. I use targeted advertising, exclusive access events, and luxury marketing that attracts high-end buyers.
                </p>
