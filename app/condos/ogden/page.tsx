...
export const metadata = {
  title: 'The Ogden Condos Las Vegas | Expired Listing Expert | Dr. Jan Duffy',
  description:
    'Expert help selling expired Ogden condos in Las Vegas. Luxury downtown high-rise condos with urban lifestyle. 30-day guarantee or work free.',
}
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none mb-12">
                <p className="text-lg text-gray-700 mb-6">
                  The Ogden is a luxury high-rise condominium building in downtown Las Vegas that offers sophisticated urban living with modern design, exclusive amenities, and prime downtown location. If your Ogden condo listing expired, you're not alone. Ogden condos face unique challenges - from marketing urban lifestyle to highlighting modern design to buyers who value downtown living. Most agents don't understand Ogden condos. They use generic strategies, and Ogden condos expire.
                </p>
                <p className="text-lg text-gray-700 mb-6">
              ...
              <div className="bg-gray-100 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Ogden condos offer urban lifestyle with downtown location, walkability, and urban amenities. Most agents don't market urban lifestyle effectively. I do. I showcase downtown location, highlight walkability, and emphasize urban amenities that attract urban-conscious buyers.
                </p>
                <h3 className="text-2xl font-bold mb-3">Modern Design</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Ogden offers modern design with contemporary finishes, sleek interiors, and urban aesthetic. Most agents don't highlight modern design effectively. I do. I showcase contemporary finishes, emphasize sleek interiors, and highlight urban aesthetic that attracts design-conscious buyers.
                </p>
                <h3 className="text-2xl font-bold mb-3">Exclusive Amenities</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Ogden offers exclusive amenities including concierge services, fitness center, rooftop pool, and exclusive access. Most agents don't showcase amenities effectively. I do. I showcase concierge services, emphasize fitness center, highlight rooftop pool, and showcase exclusive access that attracts amenity-conscious buyers.
                </p>
              </div>
              ...
              <div className="bg-white border-2 border-primary rounded-lg p-8 mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Ogden condos require luxury marketing investment. Professional photography. Luxury staging. Exclusive access events. High-end advertising. Most agents don't invest in luxury marketing. I invest $5,000+ in professional media, luxury staging, and exclusive marketing that attracts urban lifestyle seekers.
                </p>
                <h3 className="text-2xl font-bold mb-3">Urban Lifestyle Highlighting</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Ogden condos offer urban lifestyle. I highlight this lifestyle effectively. I showcase downtown location, highlight walkability, and emphasize urban amenities that attract urban-conscious buyers. Most agents don't do this. They use generic marketing, and Ogden condos expire.
                </p>
                <h3 className="text-2xl font-bold mb-3">Urban Lifestyle Seeker Targeting</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Ogden attracts urban lifestyle seekers. Young professionals. Urban enthusiasts. Downtown living seekers. Most agents don't know how to target these buyers. I do. I use targeted advertising, exclusive access events, and urban marketing that attracts urban-conscious buyers.
                </p>
              </div>
              ...
              <div className="bg-primary text-primary-foreground p-8 rounded-lg mb-12 text-center">
                ...
                <p className="text-lg opacity-90">
                  No excuses. No exceptions. If your Ogden condo doesn't sell in 30 days, I continue working at no additional cost until it sells. That's how confident I am in my Ogden condo marketing system.
                </p>
              </div>
              ...
              <div className="bg-white border-2 border-gray-200 rounded-lg p-8">
                ...
                <p className="text-center text-lg text-gray-700 mb-6">
                  If your Ogden condo listing expired, don't wait. Every day costs you money. Call me now at (702) 500-1064 or fill out the form below for a free consultation.
                </p>
