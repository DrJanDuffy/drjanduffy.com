  ...
  return (
    <>
      <BreadcrumbSchema items={[
        ...
        { name: 'Viera Condos', url: '/condos/viera' },
      ]} />
      <FAQSchema faqs={faqs} />
      <Header />
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none mb-12">
                <p className="text-lg text-gray-700 mb-6">
                  Viera is a mid-rise condominium community in Las Vegas that offers affordable living with community amenities, established neighborhoods, and value positioning. If your Viera condo home DID NOT sell, you're not alone. Viera condos face unique challenges - from competition with new construction to value-conscious buyers to emphasis on community amenities. Most agents do not understand Viera condos. They use generic strategies, and Viera condos expire.
                </p>
                <p className="text-lg text-gray-700 mb-6">
              ...
              <div className="bg-primary/10 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Viera condos expire for the same reasons other mid-rise condos expire - poor marketing, minimal investment, and zero follow-up. But Viera condos face additional challenges that most agents do not understand or address.
                </p>
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Viera attracts value-conscious buyers. Families. First-time buyers. Retirees. Most agents do not know how to market to value-conscious buyers. They use luxury marketing, and value-conscious buyers look elsewhere. I know how to market to value-conscious buyers. I emphasize affordability, highlight value, and showcase community amenities that attract value-conscious buyers.
                </p>
              ...
              <div className="bg-gray-100 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Viera offers value positioning with affordable pricing, community amenities, and established neighborhoods. Most agents do not position value effectively. I do. I highlight affordable pricing, showcase community amenities, and emphasize established neighborhoods that attract value-conscious buyers.
                </p>
              </div>
              <div className="bg-white border-2 border-primary rounded-lg p-8 mb-12">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  Viera condos offer community amenities. I highlight these amenities effectively. I showcase parks, emphasize pools, highlight community centers, and showcase family-oriented features that attract community-conscious buyers. Most agents do not do this. They use generic marketing, and Viera condos expire.
                </p>
                <h3 className="text-2xl font-bold mb-3">Value-Conscious Buyer Targeting</h3>
                <p className="text-lg text-gray-700 mb-4">
                  Viera attracts value-conscious buyers. Families. First-time buyers. Retirees. Most agents do not know how to target these buyers. I do. I use targeted advertising, community-focused marketing, and value positioning that attracts value-conscious buyers.
                </p>
              </div>
              ...
              <div className="bg-white border-2 border-gray-200 rounded-lg p-8">
                ...
                <p className="text-center text-lg text-gray-700 mb-6">
                  If your Viera condo home DID NOT sell, do not wait. Every day costs you money. Call me now at (702) 500-1064 or fill out the form below for a free consultation.
                </p>
