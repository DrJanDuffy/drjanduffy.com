            ...
            <div className="text-center mb-8">
              ...
              <div className="flex justify-center mb-6">
                <div className="relative w-32 h-32 md:w-40 md:h-40">
                  ...
                  <div className="absolute inset-0 rounded-full border-4 border-blue-600/40 shadow-2xl"></div>
                  <div className="absolute inset-2 rounded-full border-2 border-amber-400/30"></div>
                  <div className="relative w-full h-full rounded-full overflow-hidden border-4 border-blue-700/50 shadow-xl">
                    <Image
