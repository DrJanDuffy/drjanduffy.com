            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-lg max-w-none mb-12">
                <p className="text-lg text-gray-700 mb-6">
                  If your listing expired, you need to act fast. Every day your house sits unsold is costing you money - mortgage payments, HOA fees, insurance, utilities, property taxes. The average expired listing costs sellers $4,964 per month in holding costs. That's $116 per day. The longer you wait, the more you lose.
                </p>
                <p className="text-lg text-gray-700 mb-6">
                  But here's the good news: expired listings can be fixed. I've sold 47 expired Summerlin listings with an average of 19 days to contract and 98.7% of asking price. The key is getting started immediately with the right agent, the right strategy, and the right marketing. Don't let another day pass. Contact me now and let's get your expired listing sold.
                </p>
                <p className="text-lg text-gray-700 mb-6">
                  I understand how frustrating it is when your listing expires. You trusted your previous agent, they promised results, and they failed. You're angry, frustrated, and ready to work with someone who actually knows what they're doing. That's where I come in. I specialize in expired listings. This is all I do. I know how to reset them, market them, and sell them. Fast. At top dollar. With zero excuses.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-12">
                <div className="bg-primary text-primary-foreground p-8 rounded-lg text-center">
                  ...
                  <p className="text-sm opacity-75">
                    Direct line to Dr. Jan Duffy. No gatekeepers. No voicemail jail. Real conversations about your expired listing.
                  </p>
                </div>
                ...
                <div className="bg-gray-900 text-white p-8 rounded-lg text-center">
                  ...
                  <p className="text-sm opacity-75">
                    Send me details about your expired listing and I'll respond with a personalized strategy within 24 hours.
                  </p>
                </div>
              </div>
              ...
              <div className="bg-gray-100 p-8 rounded-lg mb-12">
                ...
                <p className="text-lg text-gray-700">
                  I specialize in expired listings throughout Las Vegas, with particular expertise in Summerlin West, The Ridges, Red Rock Country Club, and other luxury communities. If your listing expired anywhere in the Las Vegas area, I can help. Distance doesn't matter - results do.
                </p>
              </div>
                ...
                <div className="grid md:grid-cols-3 gap-6 text-left">
                  <div>
                    ...
                    <p className="text-lg opacity-90">
                      You call, email, or fill out the form. I respond within 24 hours (usually much faster). We discuss your expired listing, your situation, and your goals.
                    </p>
                  </div>
                  <div>
                    <h3 className="text-2xl font-bold mb-3">Step 2: Free Analysis</h3>
                    <p className="text-lg opacity-90">
                      I analyze why your listing expired and what needs to change. I'll tell you exactly what your previous agent did wrong and what I'll do differently.
                    </p>
                  </div>
                  <div>
                    <h3 className="text-2xl font-bold mb-3">Step 3: Strategy Session</h3>
                    <p className="text-lg opacity-90">
                      We discuss my 30-day plan, my guarantees, and my marketing system. You get real answers, not sales pitches. Then you decide if I'm the right agent for you.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white border-2 border-gray-200 rounded-lg p-8">
                ...
                <p className="text-center text-lg text-gray-700 mb-6">
                  Fill out the form below and I'll contact you within 24 hours. Include details about your expired listing - how long it was on the market, what your previous agent did (or didn't do), and what you're looking for in your next agent. The more information you provide, the better I can help.
                </p>
