          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto mb-12 prose prose-lg">
              <p className="text-lg text-gray-700 mb-6">
                These aren't generic testimonials from happy clients. These are real reviews from frustrated sellers whose listings expired, who fired their previous agents, and who hired me to fix the mess. Every single one of these testimonials comes from an expired listing that I sold after other agents failed.
              </p>
              <p className="text-lg text-gray-700 mb-6">
                The common thread in every testimonial? Previous agent failed. Listing expired. Seller frustrated. Then they called me. I reset the listing, implemented my 97-point marketing system, and sold it. Fast. At top dollar. With zero excuses. The testimonials below tell the story better than I ever could.
              </p>
              <h2 className="text-3xl font-black mb-4 mt-8">Why These Testimonials Matter</h2>
              <p className="text-lg text-gray-700 mb-4">
                Most agents show you testimonials from their best-case scenarios - luxury homes in perfect condition that sold quickly. I show you testimonials from expired listings. Homes that other agents couldn't sell. Homes that sat on the market for 60, 90, 120+ days. Then I show you what my clients say after I sold them in 14-31 days at 97-99% of asking price.
              </p>
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="max-w-4xl mx-auto mt-12">
                ...
                <div className="bg-gray-100 p-8 rounded-lg mb-8">
                  ...
                  <p className="text-lg text-gray-700 mb-4">
                    The results speak for themselves: 47 expired listings sold, 19 day average, 98.7% of asking price. But the testimonials tell the real story - the story of frustrated sellers who finally found an agent who actually delivers. The story of expired listings that became success stories. The story of agents who failed and an agent who succeeded.
                  </p>
                  <h3 className="text-2xl font-black mb-4 mt-6">Your Testimonial Could Be Next</h3>
                  <p className="text-lg text-gray-700">
                    Your expired listing could be the next success story. The same system that generated these 47 testimonials can generate yours. The same marketing, the same follow-up, the same guarantees. The only question is: are you ready to work with an agent who actually delivers results?
                  </p>
                </div>
              </div>
            </div>
