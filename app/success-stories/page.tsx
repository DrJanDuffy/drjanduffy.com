          ...
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto mb-12 prose prose-lg">
              <p className="text-lg text-gray-700 mb-6">
                These are not hypothetical success stories or marketing fluff. These are real HOMES THAT DIDN\'T SELL that I sold after other agents failed. Every single one of these homes sat on the market for months, bleeding money, while previous agents collected nothing and sellers lost thousands. Then they called me. I reset the listing, implemented my <a href="/marketing-strategy" className="text-primary font-semibold hover:underline">97-point marketing system</a>, and sold them. Fast. At top dollar. With zero excuses.
              </p>
              <p className="text-lg text-gray-700 mb-6">
                The numbers do not lie. I've sold 47 Summerlin sellers who couldn\'t sell with an average of 19 days to contract and 98.7% of asking price. That's not a coincidence. That's not luck. That's a proven system that works. When you see these success stories, you're seeing what's possible when you work with an agent who actually knows what they're doing. Learn about <a href="/process" className="text-primary font-semibold hover:underline">my proven 30-day selling process</a> and <a href="/services" className="text-primary font-semibold hover:underline">my complete services</a>.
              </p>
            ...
            <div className="max-w-4xl mx-auto mt-12">
              ...
              <div className="bg-gray-100 p-8 rounded-lg mb-8">
                ...
                <p className="text-lg text-gray-700 mb-4">
                  These are not cherry-picked success stories. These are real HOMES THAT didn\'t SELL that I sold after other agents failed. Every single one of these homes had the same problems: poor marketing, minimal investment, zero follow-up. Then I came in, reset everything, and sold them. Fast. At top dollar.
                </p>
                <p className="text-lg text-gray-700 mb-4">
                ...
                <p className="text-lg text-gray-700">
                  Your HOME THAT DIDN\'T SELL could be the next success story. The same system that sold these 47 HOMES THAT did not SELL can sell yours. The same marketing, the same follow-up, the same proven results. The only question is: are you ready to work with an agent who actually delivers results?
                </p>
              </div>
            </div>
          </div>
